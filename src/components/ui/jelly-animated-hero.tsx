...
// Compatible Link and Image primitives for Vite / TanStack Router environments
const Link = ({
  href,
  className,
  children,
              ...
              <div className="relative before:absolute before:inset-0 before:border-y before:border-none before:[border-image:linear-gradient(to_right,transparent,theme(colors.slate.300/.8),transparent)1]">
                ...
                >
                  <Link
                    ...
                    className="group inline-flex text-lg gap-x-2 mt-2 backdrop-blur-md text-white justify-center items-center py-3 px-5 ml-3 w-fit rounded-xl border duration-200 group bg-page-gradient border-white/30 text-md font-sans hover:border-zinc-600 hover:bg-transparent/10 hover:text-zinc-100"
                  >
                    Buy this template
